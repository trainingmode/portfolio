...
It's the _only_ tool with **1:1 translation** from the [Figma Document API]{.highlight} to [native SwiftUI layout]{.highlight}.

~[autoplay loop controls playsinline width="560" class="rounded-lg ring-(--color-primary) ring-0 ring-offset-1 hover:ring-4 active:ring-2 transition-shadow"](/public/media/layman-plugin-demo.mp4 "video/mp4")
